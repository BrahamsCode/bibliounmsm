                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <h4 class="mb-0">{{ $loans->where('status', 'returned')->where('return_date', today())->count() }}</h4>
                            </div>
                            <div class="align-self-center">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <h4 class="mb-0">{{ $loans->where('status', 'active')->filter(fn($loan) => $loan->isOverdue())->count() }}</h4>
                            </div>
                            <div class="align-self-center">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <h4 class="mb-0">{{ $loans->whereBetween('loan_date', [now()->startOfMonth(), now()->endOfMonth()])->count() }}</h4>
                            </div>
                            <div class="align-self-center">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="Estudiante, código o libro...">
                        </div>
                    </div>
                    @endif
                @endauth
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="{{ $loan->isOverdue() && $loan->status === 'active' ? 'table-warning' : '' }}">
                                ...
                                <td>
                                    <span class="fw-semibold {{ $loan->isOverdue() && $loan->status === 'active' ? 'text-danger' : '' }}">
